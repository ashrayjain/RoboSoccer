...
const double PTOPY = GTOPY + 7.874;
const double PBOTY = GBOTY - 7.874;
const double PRIGHTX = FLEFTX + 13.7795;
const double GATOPY = GTOPY + 1.9685;
const double GABOTY = GBOTY - 1.9685;
const double GARIGHTX = FLEFTX + 5.9055;
